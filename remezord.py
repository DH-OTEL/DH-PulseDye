"""
code taken from : 
    https://github.com/gitter-badger/pyFDA/blob/master/pyFDA/pyfda_lib.py
"""
...
#        dp_lin = (10**(dp/20.0)-1) / (10**(dp/20.0)+1)*2
    dF = fs-fp
    def v(dF, dp): return 2.325*((-log10(dp))**-0.445)*dF**(-1.39)
    def g(fp, dF, d): return (2.0/pi)*arctan(v(dF, dp)*(1.0/fp-1.0/(0.5-dF)))
    def h(fp, dF, c): return (2.0/pi)*arctan((c/dF)*(1.0/fp-1.0/(0.5-dF)))
